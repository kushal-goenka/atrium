...
Atrium a harassment-free experience for everyone, regardless of age, body
...
repository, discussions, issue tracker, pull requests, and any community
event — and also applies when an individual is officially representing the
community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the project maintainers at `conduct@atrium.dev` (placeholder). All
